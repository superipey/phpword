...
class TemplateProcessor
{
	...
	public function setImageValueAlt($searchAlt, $replace){        
		$id = $this->seachImagerId($searchAlt);
		if ($id != null) $this->setImageValue($this->getImgFileName($id),$replace);
    }
}
